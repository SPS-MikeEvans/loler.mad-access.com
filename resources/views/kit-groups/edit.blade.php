<x-app-layout>
        ...
        <div class="max-w-3xl mx-auto mobile-shell space-y-6">
            ...
            <div class="mobile-card sm:rounded-lg">
                <div class="mobile-card-body">
                    <form method="POST" action="{{ route('clients.kit-groups.update', [$client, $kitGroup]) }}" class="space-y-6">
                        @csrf
                        @method('PATCH')
                        ...
                        <div>
                            ...
                            @if ($assignableItems->isEmpty())
                                <p class="mt-2 text-sm text-gray-500 italic">No items available to assign.</p>
                            @else
                        ...
                        <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-3">
                            <a href="{{ route('clients.kit-groups.show', [$client, $kitGroup]) }}" class="text-sm text-brand-navy hover:text-brand-red text-center">Cancel</a>
            ...
            <div class="mobile-card sm:rounded-lg border border-red-100">
                <div class="mobile-card-body">
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        Deleting a group leaves the equipment intact but removes items from this group.
                    </p>
                    <x-danger-button
                        type="button"
                        x-data
    ...
    <x-confirmed-action-modal
        ...
        :action="route('clients.kit-groups.destroy', [$client, $kitGroup])"
        method="DELETE"
